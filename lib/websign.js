(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("WebSign", [], factory);
	else if(typeof exports === 'object')
		exports["WebSign"] = factory();
	else
		root["WebSign"] = factory();
...
var _websign = __webpack_require__(22);

var _websign2 = _interopRequireDefault(_websign);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

exports.default = _websign2.default;
...
var _eventEmitterEs = __webpack_require__(45);
...
var WebSign = function (_EventEmitter) {
  _inherits(WebSign, _EventEmitter);

  function WebSign() {
    _classCallCheck(this, WebSign);

    var _this = _possibleConstructorReturn(this, (WebSign.__proto__ || Object.getPrototypeOf(WebSign)).call(this));

    _this.socket = (0, _socket2.default)('http://127.0.0.1:7721');

    var that = _this;

    _this.socket.on('connect', function (err) {
      that.emit('service-available', err);
    });
    _this.socket.io.on('connect_error', function (err) {
      that.emit('service-unavailable', err);
    });
    _this.socket.on('signed data', function (data) {
      that.emit('signed-data', data);
    });
    return _this;
  }

  _createClass(WebSign, [{
    key: 'sign',
...
//# sourceMappingURL=WebSign.js.map